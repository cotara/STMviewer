...
const char MULTY_LASER_MODE = 0x22;
const char NEWSHADFINDPAR   = 0x17;
const char REQUEST_DIAMETER = 0x72;

//Статус:
//8 экстремумов         16 байт         все модели
//************************************************
//2 ошибки              4 байт         все модели
//************************************************
//6 значений кнопок     12 байт         все модели
//************************************************
//4 значения ср. и дл.  8 байт         все модели кроме 200
//************************************************
//12 значений ср. и дл.  24 байт         200
//************************************************
//2 значения оффсеты   4 байт          20,40,50
//************************************************
//4 центры и диаметры  32 байт         все модели
