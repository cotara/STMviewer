...
{
    ui->NxSpinBox->setValue(paramsDouble.at(0));
    ui->NySpinBox->setValue(paramsDouble.at(1));
    ui->HxSpinBox->setValue(paramsDouble.at(2));
    ui->HySpinBox->setValue(paramsDouble.at(3));
    ui->CxSpinBox->setValue(paramsDouble.at(4));
    ui->CySpinBox->setValue(paramsDouble.at(5));
}
...
{
    QString tempToWrite;
    tempToWrite =   "Nx=" + QString::number(paramsDouble.at(0),'g',10) + '\n'+ //Здесь обрезает до 6 знаков после запятой
                    "Ny=" + QString::number(paramsDouble.at(1),'g',10) + '\n'+
                    "Hx=" + QString::number(paramsDouble.at(2),'g',10) + '\n'+
                    "Hy=" + QString::number(paramsDouble.at(3),'g',10) + '\n'+
                    "Cx=" + QString::number(paramsDouble.at(4),'g',10) + '\n'+
                    "Cy=" + QString::number(paramsDouble.at(5),'g',10);
    if(file->isOpen())
         file->close();
